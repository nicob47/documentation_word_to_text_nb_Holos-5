...
namespace H.Avalonia.Test.ViewModels.ComponentViews.OtherAnimals
{
    ...
    public class HorsesComponentViewModelTests
    {
        ...
        public void TestInitialize()
        {
            ...
            _viewModel = new HorsesComponentViewModel(mockLogger.Object, _mockAnimalComponentService.Object, _storageServiceMock, mockManagementPeriodService.Object, Mock.Of<H.Avalonia.Services.DietFormulator.IDietFormulatorWindowService>());
        }
