...
namespace H.Avalonia.Test.ViewModels.ComponentViews.OtherAnimals
{
    ...
    {
        private GoatsComponentViewModel _viewModel = null!;
        ...
        public void TestInitialize()
        {
            ...
            _viewModel = new GoatsComponentViewModel(mockLogger.Object, _mockAnimalComponentService.Object, _storageServiceMock, mockManagementPeriodService.Object, Mock.Of<H.Avalonia.Services.DietFormulator.IDietFormulatorWindowService>());
        }
