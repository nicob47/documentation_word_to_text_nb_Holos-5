...
namespace H.CLI.ComponentKeys
{
    public class SheepKeys : AnimalKeyBase, IComponentKeys
    {
        ...
        public SheepKeys() : base()
        {
            ...
            base.Keys.Add(AppStrings.Column_EnergyRequiredToProduceWool, ImperialUnitsOfMeasurement.BritishThermalUnitPerPound);
            base.Keys.Add(AppStrings.Column_WoolProduction, ImperialUnitsOfMeasurement.PoundsPerYear);
            base.Keys.Add(AppStrings.Column_EnergyRequiredToProduceMilk, ImperialUnitsOfMeasurement.BritishThermalUnitPerPound);
            ...
            base.Keys.Add(AppStrings.Column_GainCoefficientA, null);
            base.Keys.Add(AppStrings.Column_GainCoefficientB, null);
